                ...
                <div class="card-body">
                  ...
                  <form method="post" action="{{url('admin/add-category')}}">
                    ...
                    <div class="form-group row">       
                      ...
                      <input type="text"  placeholder="Category" id="category_name" name="category_name" class="form-control mb-3" required validate="name">
                    </div>
                   ...
                   <textarea class="form-control mb-3" rows="5" id="category_desc" name="category_desc" required></textarea>
                     ...
                     <div class="form-group row">       
                      ...
                      <input type="text" placeholder="Category url" id="category_url" name="category_url" class="form-control mb-3" required validate="name">
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row text-center">       
                      <button type="submit" class="btn btn-success mt-3 btn-block" id="add_category" name="add_category" required>Add Post</button>
                    </div>
