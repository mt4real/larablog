      ...
      <div class="container">
        <div class="form-outer text-center d-flex align-items-center">
          <div class="form-inner">
            ...
            <p>Welcome to Lara Blog, here you can log in as an Admin</p>
            ...
            <form class="text-left form-validate"  method="post" action="{{url('/admin')}}">
              ...
              <div class="form-group">
                <label for="login-password" class="password">Password</label>
            ...
            </form><a href="{{url('admin/forgot-password')}}" class="forgot-pass">Forgot Password?</a><small>Do not have an account? </small><a href="{{url('admin/register')}}" class="signup">Signup</a>
          </div>
